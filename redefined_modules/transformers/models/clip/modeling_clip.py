...
from ....elementwise_ops import Add, MatMul
...
class CLIPAttention(nn.Module):
    ...
    def replace_linear_to_conv(self):
        ...
        if not hasattr(self, 'forward_using_linear'):
            self.forward_using_linear = self.forward
            self.forward = self._forward_using_conv

    def _forward_using_conv(
        self,
        hidden_states: torch.Tensor,
        attention_mask: Optional[torch.Tensor] = None,
        causal_attention_mask: Optional[torch.Tensor] = None,
...
class CLIPEncoderLayer(nn.Module):
    def __init__(self, config: CLIPConfig):
        ...
        self.skip_connection_1 = Add()
        self.skip_connection_2 = Add()
